...
var InformationCaption = `Эта таблица была создана ботом.
Основа данных - отзывы учеников на прошедшие уроки.
Если у вас есть пожелания или вопросы,
то напишите мне в telegram (https://t.me/Anrull)`
...
var DayTextToInt = map[string]string{"пн": "0", "вт": "1", "ср": "2", "чт": "3", "пт": "4"}
